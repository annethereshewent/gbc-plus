...
export const webemulator_is_rtc_dirty: (a: number) => number;
export const webemulator_clear_rtc_dirty: (a: number) => void;
export const webemulator_get_buffer_len: (a: number) => number;
export const webemulator_update_input: (a: number, b: number, c: number, d: number) => void;
